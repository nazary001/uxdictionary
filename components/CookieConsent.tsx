...
export const CONSENT_EVENT = "uxdictionary:consent";
export const CONSENT_STORAGE_KEY = "uxdictionary_consent";
  ...
  return (
    <div
      ...
      className={[
        ...
        "shadow-[0_10px_34px_-12px_rgb(0_0_0_/0.70)]",
    ...
    >
      ...
      <div className="mt-3 flex items-center gap-2">
        <button
          ...
          className="rounded-lg bg-pine px-4 py-1.5 text-[13px] font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-pine-deep hover:shadow-[0_4px_14px_rgb(109_94_252_/0.45)] active:translate-y-0 active:shadow-none motion-reduce:transition-none motion-reduce:hover:translate-y-0"
        >
          Accept
        </button>
        <button
          ...
          className="rounded-lg border border-line px-4 py-1.5 text-[13px] font-medium text-moss transition-all duration-200 hover:-translate-y-0.5 hover:border-pine hover:bg-parchment hover:text-ink active:translate-y-0 active:shadow-none motion-reduce:transition-none motion-reduce:hover:translate-y-0"
        >
          Decline
        </button>
      </div>
