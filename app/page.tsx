      ...
      <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
        <section aria-label="Featured stories" className="reveal min-w-0">
          {hero ? (
            ...
            <div className="card-lift relative overflow-hidden border border-line bg-card p-8 text-center sm:p-12">
              <span
                aria-hidden="true"
                className="pointer-events-none absolute inset-0"
                style={{
                  background:
                    "radial-gradient(60% 80% at 50% 0%, rgba(109,94,252,0.18), transparent 70%)",
                }}
              />
              <div className="relative">
                <p className="tag-cap">Design publication &amp; glossary</p>
                <h1 className="mx-auto mt-3 max-w-xl font-display text-3xl font-bold leading-tight tracking-tight sm:text-4xl">
                  Design, <span className="u-marker">decoded</span>.
                </h1>
                <p className="mx-auto mt-4 max-w-lg leading-relaxed text-moss">
                  {SITE_NAME} is a design publication and living glossary —
                  essays, patterns and clear definitions on UX, UI, research
                  and design systems for people who craft digital products.
                </p>
              </div>
              <div className="relative mt-8">
                <EmptyState
                  title="The first entries are in progress"
                  note="Our editors are preparing the first essays and glossary definitions. Browse the sections below to see what's coming."
                />
              </div>
            </div>
          )}
        ...
        >
          <div className="card-lift border border-line bg-card p-5">
        ...
        >
          {CATEGORIES.map((category) => (
            <a
              key={category.slug}
              href={`/category/${category.slug}`}
              className="card-lift group border border-line bg-card p-6"
            >
