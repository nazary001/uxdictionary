  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 text-center sm:px-6">
      ...
      <h1 className="mt-4 font-display text-3xl font-semibold tracking-tight">
        This page is <span className="u-marker">undefined</span>
      </h1>
      <p className="mx-auto mt-4 max-w-md leading-relaxed text-moss">
        No entry matches this address — it may be mistyped, or the page was
        moved. Head back to the homepage or browse one of the sections.
      </p>
