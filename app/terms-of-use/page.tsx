  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <div className="article-body mt-8">
        ...
        <p>
          All content on the Site — definitions, essays, patterns and guides —
          is published for general informational and educational purposes. It is{" "}
          <strong>not</strong> professional design, business or legal advice.
          Design practice, tools and terminology evolve; treat our material as a
          starting point and apply your own judgement in context.
        </p>

        <h2>No professional relationship</h2>
        <p>
          Reading the Site or contacting us does not create a consulting or
        ...
        <p>
          The Site links to external websites — design tools, references and
          other resources. We are not responsible for their content, accuracy or
          practices. Some pages may contain partner links, which are disclosed
          where they appear.
        </p>
