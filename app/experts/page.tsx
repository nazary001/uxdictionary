...
export const metadata = pageMeta({
  title: "Our Experts",
  description: `Meet the designers, researchers and writers behind ${SITE_NAME} — the contributors who define the terms and write the essays.`,
  path: "/experts",
});
    ...
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <header className="reveal rule-double pb-6">
        ...
        <p className="mt-3 max-w-2xl leading-relaxed text-moss">
          Every definition and essay on {SITE_NAME} is written by a working
          designer or researcher. Here&apos;s the team behind the glossary —
          the people pinning down the terms and translating the craft.
        </p>
      </header>
