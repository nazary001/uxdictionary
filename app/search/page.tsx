...
export const metadata: Metadata = {
  title: "Search",
  description: "Search every definition, essay and pattern on the site.",
  robots: { index: false },
};
      ...
      <header className="reveal rule-double pb-6">
        ...
        <form action="/search" role="search" className="mt-6 flex items-center gap-2">
          <input
            ...
            defaultValue={query}
            required
            placeholder="Try “design systems” or “usability testing”…"
      ...
      <div className="reveal reveal-2 mt-8">
        ...
        {query ? (
          ...
          <p className="text-center text-sm text-moss">
            Type a term or topic above to search every entry and essay on the site.
          </p>
        )}
      </div>
    </div>
